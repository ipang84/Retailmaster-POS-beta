...
import ImportExportCustomers from '../components/ImportExportCustomers';
...
function Customers() {
  ...
  useEffect(() => {
    ...
    // Listen for custom event when customer data changes
    const handleCustomerDataChanged = () => {
      loadCustomers();
    };
    
    window.addEventListener('storage', handleStorageChange);
    window.addEventListener('customerDataChanged', handleCustomerDataChanged);
    
    return () => {
      window.removeEventListener('storage', handleStorageChange);
      window.removeEventListener('customerDataChanged', handleCustomerDataChanged);
    };
  }, []);
  ...
  return (
    <PageContainer>
      <PageHeader>
        ...
        <HeaderActions>
          <ActionButton onClick={() => setShowImportExportModal(true)}>
            <FiDownload />
            Import/Export
          </ActionButton>
