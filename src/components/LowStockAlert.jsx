  ...
  return (
    <AlertContainer>
          ...
          {lowStockItems.map(product => (
            <div key={product.id} className="product-item">
              ...
              <div className="stock-info">
                <span className="current">{product.stock}</span>
                <span className="min">(min: {product.lowStockThreshold})</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <AlertActions>
        ...
        <Link to="/reports/low-stock" className="action-button primary">
          View Report
        </Link>
      </AlertActions>
    </AlertContainer>
